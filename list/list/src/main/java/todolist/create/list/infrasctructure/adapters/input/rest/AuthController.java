...
public class AuthController {
    ...
    public ResponseEntity<Object> login(@RequestBody User user) {
        try {
            ...
            List<Tache> taches = tachePort.getTachesByUserId(existingUser.getId()); // Utilisez tachePort ici

            // Créer la réponse avec le token et les informations de l'utilisateur
            Map<String, Object> authData = new HashMap<>();
            authData.put("token", token);
            authData.put("type", "Bearer");
            authData.put("user", existingUser); // Inclure les informations de l'utilisateur
            authData.put("taches", taches); // Inclure les tâches de l'utilisateur
