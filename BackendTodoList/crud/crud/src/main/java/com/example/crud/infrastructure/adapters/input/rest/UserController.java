...
public class UserController {
    ...
    public ResponseEntity<User> createUser(@RequestBody User user) {
        return ResponseEntity.ok(userPort.createUser(user.getNom(), user.getPrenom(), user.getEmail(), user.getPassword()));
    }
    ...
    public ResponseEntity<User> updateUser(@PathVariable Long id, @RequestBody User updatedUser) {
        return ResponseEntity.ok(userPort.updateUser(id, updatedUser.getNom(), updatedUser.getPrenom(), updatedUser.getEmail()));
    }
